...
<tr class="<%#GetPostClass()%>">
    <td valign="top" height="<%# GetUserBoxHeight() %>" colspan='<%#GetIndentSpan()%>'>
        <div class="row">
...
<tr class="postfooter">
    <td colspan='<%#GetIndentSpan()%>'>
        <div class="row">
            <div class="col-sm-12 postTop">
                <div class="leftItem">
                <a onclick="ScrollToTop();" class="postTopLink" href="javascript: void(0)">            
                    <YAF:ThemeImage LocalizedTitlePage="POSTS" LocalizedTitleTag="TOP"  runat="server" ThemeTag="TOTOPPOST" />
                </a>
                <span id="IPSpan1" class="postInfoRight postInfoIp" runat="server" visible="false"> 
		            &nbsp;&nbsp;
